...
<body>
  <div class="container">
    <div id="header">
      <h1 id="logo">Tambah Data Mahasiswa</h1>
    </div>
    <hr>
    <nav>
        <ul>
            <li><a href="student_view.php" style="color: aliceblue; justify-content: center; display: flex; margin-top: 30px">Lihat Data</a></li>
